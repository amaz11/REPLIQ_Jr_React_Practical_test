...
const Products = () => {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 mx-3 md:mx-0 mt-3 md:grid-cols-2 lg:grid-cols-4 ">
      {data?.map((item) => {
        return (
          <div
            className="relative flex flex-col w-full max-w-xs  overflow-hidden bg-white border border-gray-100 rounded-lg shadow-md"
            key={item?._id}
          >
            <Link
